...
def generate_launch_description():
    ...
    air_calibration_path = os.path.join(poolrobot_pkg_dir, 'config', 'air_calibration.yaml')
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            parameters=[{'calyaml_path': air_calibration_path}]
        ),

        #Run my algorithm to count tf.
        Node(
            package = 'poolrobot',
            executable = 'tag_initialisation_node',
            name = 'tag_initialisation'
        ),
